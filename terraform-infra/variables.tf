...
variable "webapp_port"   { type = number, default = 3000 }
variable "api_port"      { type = number, default = 30000 }
variable "db_name"       { type = string, default = "appdb" }
variable "db_username"   { type = string, default = "admin" }
variable "db_password"   { type = string, sensitive = true }
variable "db_instance_class" { type = string, default = "db.t3.micro" }
variable "jwt_token"     { type = string, sensitive = true }
variable "service_secret" { type = string, sensitive = true }
